...
class Compose(object):
    ...
    def __call__(self, image, **kwargs):
        for t in self.transforms:
            ...
            if a is 'RandomResizedCrop':
                image_ema = image.copy()
                image_ema, kwargs0 = ToTensor().__call__(image_ema, **kwargs)
                image_ema, kwargs0 = Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225]).__call__(image_ema, **kwargs)
                kwargs['image_ema'] = image_ema
        return image, kwargs
